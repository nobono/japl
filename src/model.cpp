...
PYBIND11_MODULE(model, m) {
    pybind11::class_<Model>(m, "Model")
        ...
        .def("set_masstable", &Model::set_masstable)
        ...
        .def_property("masstable",
                      [](const Model& self) -> const MassTable& {return self.masstable;},  // getter
                      [](Model& self, const decltype(Model::masstable)& value) {self.masstable = value;})  // setter
